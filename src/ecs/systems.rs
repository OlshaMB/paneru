    ...
    W: Fn(Entity) -> Option<IRect>,
{
    ...
    Some(if viewport.width() < total_strip_width {
...
pub(crate) fn reposition_dragged_window(
    ...
    if active_workspace.velocity.abs() > 0.1 || active_workspace.is_user_swiping {
...
pub(super) fn update_overlays(
    ...
    let swiping = active_workspace.velocity.abs() > 0.1 || active_workspace.is_user_swiping;
